...
/**
 * Created by Stefanos on 8/7/2016.
 */
public class Constants {

    public static String SERVER_ = "192.168.1.6";

    public static String PORT =  "9933";

    public static final String FB_APP_ID = "421905537937918";

    public static final int RECCOVERY_ALLOWANCE_TIME = 120;
    ...
    public static String ALERT_EXCHANGE_CARD = "You exhange only 3 cards";
